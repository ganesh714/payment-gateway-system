...
Since the submission form may not accept image uploads, these screenshots verify the system's functionality.

**1. Order Creation (API Response)**
> *Shows the unique order ID generated by the backend.*
![Order Creation](docs/screenshots/order_creation.png)

**2. Hosted Checkout UI**
> *The payment page loaded with the correct Order ID and Amount.*
![Checkout Page](docs/screenshots/checkout_page.png)

**3. Success State**
> *The "Payment Successful" confirmation.*
![Payment Success](docs/screenshots/payment_success.png)

**4. Merchant Dashboard**
> *The transaction recorded in the admin panel.*
